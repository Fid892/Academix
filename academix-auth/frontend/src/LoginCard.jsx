...
const LoginCard = () => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -10 }}
      className="glass-card login-card-container"
    >
      <div className="card-content">
        <div className="logo-section">
          ...
          <div className="brand-tagline">Empowering Minds, Connecting Communities</div>
        </div>

        <motion.button
          whileHover={{ scale: 1.05, boxShadow: "0 0 20px rgba(235, 64, 52, 0.4)" }}
          whileTap={{ scale: 0.95 }}
